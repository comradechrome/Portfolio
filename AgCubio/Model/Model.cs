...
namespace AgCubio
{
   ...
   public class Cube
   {
      ...
      /// <summary>
      /// That rate at which merges are not allowed - when tis value is zero, cubes can merge
      /// </summary>
      [JsonIgnore]
   ...
   public class World
   {
      ...
      /// <summary>
      ///  Dictionary or team IDs and all of the cubes under that team ID
      /// </summary>
      ...
      public void removeCube(Cube cube)
      {
         ...
         if (teams.ContainsKey(cube.team_id) && teams[cube.team_id].Contains(cube))
   ...
   /// <summary>
   /// Contains game constants/parameters to adjust game play. Default values can be overridden by an xml file
   /// </summary>
   public class WorldParams
   {
      ...
      /// <summary>
      /// maximum distance a cube can split
      /// </summary>
      ...
      /// <summary>
      /// the starting mass of a player
      /// </summary>
      public int playerStartMass { get; } = 1000;
      /// <summary>
      /// the maximum number of food cubes in the game
      /// </summary>
      public int maxFood { get; } = 5000;
      /// <summary>
      /// the minimum mass of a cube that can split
      /// </summary>
      ...
      /// <summary>
      /// The maximum height/width a player can view
      /// </summary>
      public int maxViewRange { get; } = 10000;
      /// <summary>
      /// The number of game heart beats that occur per second
      /// </summary>
      ...
      /// <summary>
      /// above this mass, a player will have double attrition 
      /// </summary>
      ...
      /// <summary>
      /// This value multiplied by the cubes width is how far a split cube is 'thrown'
      /// </summary>
      ...
      /// <summary>
      /// The momentum of a split cube. This causes a plit cube to move faster for a short amount of time
      /// </summary>
      public int splitMomentum { get; } = 50;
      /// <summary>
      /// This is the decay constant that must reach zero before cubes are able to merge again
      /// </summary>
      public int splitDecay { get; } = 10;
      /// <summary>
      /// After hitting a virus, this is the decay constant that must reach zero before cubes are able to merge again
      /// </summary>
